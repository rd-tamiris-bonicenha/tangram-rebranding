...
`,Z=(0,l.ZP)(p.Z)`
  ...
  left: 0;
  width: 280px;
`,w=(0,n.forwardRef)(((e,t)=>{let{locale:a=c.Z,...i}=e;const{date:o,changeYear:l}=i;let s=o;return n.createElement(v,(0,r.Z)({ref:t},i),n.createElement(y,null,n.createElement(b,{kind:u.Z.kinds.tertiary,size:h.Z.sizes.sm,onClick:()=>l((0,m.default)(s)-1),"aria-controls":"headerNavigation"},n.createElement(g.Z,{id:"previous-year",title:"go to previous year",titleId:"previous-year"})),n.createElement(Z,{id:"headerNavigation","aria-live":"assertive"},(0,m.default)(s)),n.createElement(b,{kind:u.Z.kinds.tertiary,size:h.Z.sizes.sm,onClick:()=>l((0,m.default)(s)+1),"aria-controls":"headerNavigation"},n.createElement(f.Z,{id:"next-year",title:"go to next year",titleId:"next-year"}))))}));w.displayName="DatePicker.YearlyHeader",w.propTypes={locale:o().object};const x=w;var k=a(54571),_=a(64083),z=a(87926),E=a(37811),C=a(17752),$=a(20376),R=a(69419),I=a(22015),P=a(38722);const S="48px",N=l.ZP.div`
  display: flex;
  justify-content: space-between;
  position: absolute;
  width: calc(100% - (var(--size-spacing-04) * 2));
...
`,L=(0,n.forwardRef)(((e,t)=>{let{locale:a=c.Z,...i}=e;const{monthsShown:o,date:l,decreaseMonth:s,increaseMonth:d,prevMonthButtonDisabled:v,nextMonthButtonDisabled:y,titleAction:b}=i,Z=!R.Z(b)&&{forwardedAs:"div",tabindex:"-1"},w=Array(o).fill(0);let x=document.getElementsByClassName("react-datepicker__month"),S=l;if(o>1&&x.length){const e=x[0].getAttribute("aria-label").replace("month","").trim().split("-").join("/");S=new Date(`${e}/01`)}return n.createElement(N,(0,r.Z)({ref:t},i),n.createElement(T,null,n.createElement(D,{kind:u.Z.kinds.tertiary,onClick:s,disabled:v,"aria-controls":"headerNavigation"},n.createElement(g.Z,{id:"previous-month",title:"go to previous month",titleId:"previous-month"})),n.createElement(I.Z,{id:"headerNavigation","aria-live":"assertive"},w.map(((e,t)=>n.createElement(A,(0,r.Z)({key:`header-${t}`,second:!!t,token:p.Z.tokens.TEXT_MD_BOLD,onClick:b,kind:h.Z.kinds.tertiary,size:h.Z.sizes.md},Z),`${(0,P.G4)(a)[(0,E.default)((0,z.default)(S,t))]} ${(0,m.default)(S)}`)))),n.createElement(D,{kind:u.Z.kinds.tertiary,onClick:d,disabled:y,"aria-controls":"headerNavigation"},n.createElement(f.Z,{id:"next-month",title:"go to next month",titleId:"next-month"}))),n.createElement(T,null,w.map(((e,t)=>n.createElement(M,{as:$.Z.as.ul,key:`weekdays-${t}`},((e,t)=>{const a=(0,k.default)(t,{locale:e});return[].concat([0,1,2,3,4,5,6].map((t=>{const r=(0,_.default)(a,t),i=e.localize.day((0,C.default)(r),{width:"short"});return n.createElement("li",{key:t,className:"react-datepicker__day-name"},i)})))})(a,(0,z.default)(S,t)))))))}));L.displayName="DatePicker.MonthlyHeader",L.propTypes={locale:o().object,titleAction:o().func};const j=L,F="40px",q=l.ZP.div`
  width: fit-content;
