"use strict";(self.webpackChunkdocs=self.webpackChunkdocs||[]).push([[8611],{38e3:(e,t,a)=>{a.d(t,{D:()=>m,Z:()=>s});var r=a(25773),n=a(27378),i=a(67468),o=a(33099);const l=i.ZP.div`
...
`,Z=(0,l.ZP)(p.Z)`
  ...
  left: 0;
  width: 280px;
`,w=(0,n.forwardRef)(((e,t)=>{let{locale:a=c.Z,...i}=e;const{date:o,changeYear:l}=i;let s=o;return n.createElement(v,(0,r.Z)({ref:t},i),n.createElement(y,null,n.createElement(b,{kind:u.Z.kinds.tertiary,size:h.Z.sizes.sm,onClick:()=>l((0,m.default)(s)-1),"aria-controls":"headerNavigation"},n.createElement(g.Z,{id:"previous-year",title:"go to previous year",titleId:"previous-year"})),n.createElement(Z,{id:"headerNavigation","aria-live":"assertive"},(0,m.default)(s)),n.createElement(b,{kind:u.Z.kinds.tertiary,size:h.Z.sizes.sm,onClick:()=>l((0,m.default)(s)+1),"aria-controls":"headerNavigation"},n.createElement(f.Z,{id:"next-year",title:"go to next year",titleId:"next-year"}))))}));w.displayName="DatePicker.YearlyHeader",w.propTypes={locale:o().object};const x=w;var k=a(54571),_=a(64083),z=a(87926),E=a(37811),C=a(17752),$=a(20376),R=a(69419),I=a(22015),S=a(38722);const P="48px",N=l.ZP.div`
  display: flex;
  justify-content: space-between;
  position: absolute;
  width: calc(100% - (var(--size-spacing-04) * 2));
...
`,L=(0,n.forwardRef)(((e,t)=>{let{locale:a=c.Z,...i}=e;const{monthsShown:o,date:l,decreaseMonth:s,increaseMonth:d,prevMonthButtonDisabled:v,nextMonthButtonDisabled:y,titleAction:b}=i,Z=!R.Z(b)&&{forwardedAs:"div",tabindex:"-1"},w=Array(o).fill(0);let x=document.getElementsByClassName("react-datepicker__month"),P=l;if(o>1&&x.length){const e=x[0].getAttribute("aria-label").replace("month","").trim().split("-").join("/");P=new Date(`${e}/01`)}return n.createElement(N,(0,r.Z)({ref:t},i),n.createElement(T,null,n.createElement(D,{kind:u.Z.kinds.tertiary,onClick:s,disabled:v,"aria-controls":"headerNavigation"},n.createElement(g.Z,{id:"previous-month",title:"go to previous month",titleId:"previous-month"})),n.createElement(I.Z,{id:"headerNavigation","aria-live":"assertive"},w.map(((e,t)=>n.createElement(A,(0,r.Z)({key:`header-${t}`,second:!!t,token:p.Z.tokens.TEXT_MD_BOLD,onClick:b,kind:h.Z.kinds.tertiary,size:h.Z.sizes.md},Z),`${(0,S.G4)(a)[(0,E.default)((0,z.default)(P,t))]} ${(0,m.default)(P)}`)))),n.createElement(D,{kind:u.Z.kinds.tertiary,onClick:d,disabled:y,"aria-controls":"headerNavigation"},n.createElement(f.Z,{id:"next-month",title:"go to next month",titleId:"next-month"}))),n.createElement(T,null,w.map(((e,t)=>n.createElement(M,{as:$.Z.as.ul,key:`weekdays-${t}`},((e,t)=>{const a=(0,k.default)(t,{locale:e});return[].concat([0,1,2,3,4,5,6].map((t=>{const r=(0,_.default)(a,t),i=e.localize.day((0,C.default)(r),{width:"short"});return n.createElement("li",{key:t,className:"react-datepicker__day-name"},i)})))})(a,(0,z.default)(P,t)))))))}));L.displayName="DatePicker.MonthlyHeader",L.propTypes={locale:o().object,titleAction:o().func};const j=L,F="40px",O=l.ZP.div`
  width: fit-content;
...
`,q=(0,n.forwardRef)(((e,t)=>{let{range:a,className:i,titleAction:o,placeholder:l,position:m=q.positions.bottom,selected:u=null,locale:p=c.Z,double:h=!1,yearlyView:g=!1,inline:f=!1,startDate:v=null,endDate:y=null,onChange:b=(()=>{}),dateFormat:Z="dd/MM/yyyy",...w}=e;(0,s.registerLocale)("locale",p);const k=(0,n.useRef)(t),[_,z]=(0,n.useState)(!1),E=h?2:1;return(0,n.useLayoutEffect)((()=>{if(f){const e=k.current.calendar.componentNode.querySelector(".react-datepicker__day--keyboard-selected"),t=k.current.calendar.componentNode.querySelector(".react-datepicker__day--selected");e&&t&&(e.classList.remove("react-datepicker__day--keyboard-selected"),t.classList.add("react-datepicker__day--keyboard-selected"))}}),[u,f]),(0,n.useLayoutEffect)((()=>{if(g&&(_||f)){const e=Array.from(k.current.calendar.componentNode.querySelectorAll(".react-datepicker__month-text"));k.current.calendar.componentNode.querySelectorAll(".react-datepicker__month-wrapper").forEach((t=>{const a=e.splice(0,4);if(a.length)return a.map((e=>t.appendChild(e)));t.style.display="none"}))}}),[g,_,f]),n.createElement(O,{$monthsShown:h,$yearlyView:g,className:i,$inline:f},n.createElement(d(),(0,r.Z)({selected:u,onCalendarClose:()=>z(!1),onCalendarOpen:()=>z(!0),renderCustomHeader:e=>(e=>g?n.createElement(x,(0,r.Z)({locale:p},e)):n.createElement(j,(0,r.Z)({titleAction:o,monthsShown:E,locale:p},e)))(e),locale:"locale",monthsShown:E,popperPlacement:m,showPopperArrow:!1,showMonthYearPicker:g,inline:f,ref:k,placeholderText:l,startDate:v,endDate:y,onChange:b,dateFormat:Z},w)))}));q.displayName="DatePickerBase",q.positions={top:"top-start",bottom:"bottom-start"},q.propTypes={position:o().oneOf([q.positions.top,q.positions.bottom]),selected:o().instanceOf(Date),startDate:o().instanceOf(Date),endDate:o().instanceOf(Date),inline:o().bool,onChange:o().func,locale:o().object,dateFormat:o().string,double:o().bool,yearlyView:o().bool,titleAction:o().func,placeholder:o().string};const W=q},53344:(e,t,a)=>{a.d(t,{Z:()=>y});var r=a(25773),n=a(27378),i=a(23615),o=a.n(i),l=a(67468),s=a(45908),d=a(24044),c=a(72429),m=a(79372),u=a(74903),p=a(38722);const h=(0,l.ZP)(d.Z)``,g=l.ZP.span`
  display: inline-flex;
  align-items: center;
  font: var(--text-md-bold);
  background-color: var(--neutral-surface);
`,f=l.ZP.div`
  ...
  align-items: center;
  border-radius: var(--border-radius-sm);
`,v=(0,n.forwardRef)(((e,t)=>{let{value:a,className:i,startDate:o="",endDate:l="",onStartChange:d=(()=>{}),onEndChange:v=(()=>{}),onChange:y=(()=>{}),firstInputRef:b=null,secondInputRef:Z=null,dateFormat:w="dd/MM/yyyy",locale:x=s.Z,double:k=!1,..._}=e;const[z,E]=(0,n.useState)(o),[C,$]=(0,n.useState)(l);let R=(0,n.useRef)(null),I=(0,n.useRef)(null);(0,n.useEffect)((()=>{E(o)}),[o]),(0,n.useEffect)((()=>{$(l)}),[l]);const S=e=>{const t=!c.Z(e.target.value,w.length);m.Z(e.target,[R.current])&&(E(e.target.value),t&&(d((0,p.sG)(e.target.value,w,x)),y(e))),m.Z(e.target,[I.current])&&($(e.target.value),t&&(v((0,p.sG)(e.target.value,w,x)),y(e)))};return n.createElement(f,{ref:t},k?n.createElement(n.Fragment,null,n.createElement(h,(0,r.Z)({prefix:n.createElement(u.Z,{title:"Datepicker",titleId:"datepicker-input"}),rootRef:R,ref:b,className:`range-start datepicker-input ${i}`,type:"text",value:z,onChange:S},_)),n.createElement(g,null,"-"),n.createElement(h,(0,r.Z)({rootRef:I,ref:Z,className:`range-end datepicker-input ${i}`,type:"text",value:C,onChange:S},_))):n.createElement(h,(0,r.Z)({prefix:n.createElement(u.Z,{title:"Datepicker",titleId:"datepicker-input"}),value:a,onChange:y,className:`datepicker-input ${i}`},_,{ref:t})))}));v.displayName="DatePickerInput",v.propTypes={placeholder:o().string,startDate:o().string,endDate:o().string,onStartChange:o().func,onEndChange:o().func,locale:o().object,dateFormat:o().string,double:o().bool,firstInputRef:o().oneOfType([o().func,o().shape({current:o().any})]),secondInputRef:o().oneOfType([o().func,o().shape({current:o().any})])};const y=v},14272:(e,t,a)=>{a.d(t,{Z:()=>f});var r=a(25773),n=a(27378),i=a(23615),o=a.n(i),l=a(67468),s=a(45908),d=a(48981),c=a(728),m=a(53344),u=a(38722);const p=(0,l.ZP)(c.Z)`
  border-radius: var(--border-radius-sm);
