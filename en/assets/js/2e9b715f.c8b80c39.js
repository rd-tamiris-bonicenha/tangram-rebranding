...
`,Z=(0,l.ZP)(p.Z)`
  ...
  left: 0;
  width: 280px;
`,w=(0,n.forwardRef)(((e,t)=>{let{locale:a=c.Z,...i}=e;const{date:o,changeYear:l}=i;let s=o;return n.createElement(v,(0,r.Z)({ref:t},i),n.createElement(y,null,n.createElement(b,{kind:u.Z.kinds.tertiary,size:h.Z.sizes.sm,onClick:()=>l((0,m.default)(s)-1),"aria-controls":"headerNavigation"},n.createElement(g.Z,{id:"previous-year",title:"go to previous year",titleId:"previous-year"})),n.createElement(Z,{id:"headerNavigation","aria-live":"assertive"},(0,m.default)(s)),n.createElement(b,{kind:u.Z.kinds.tertiary,size:h.Z.sizes.sm,onClick:()=>l((0,m.default)(s)+1),"aria-controls":"headerNavigation"},n.createElement(f.Z,{id:"next-year",title:"go to next year",titleId:"next-year"}))))}));w.displayName="DatePicker.YearlyHeader",w.propTypes={locale:o().object};const x=w;var k=a(54571),_=a(64083),z=a(87926),E=a(37811),C=a(17752),$=a(20376),R=a(69419),S=a(22015),I=a(38722);const N="48px",T=l.ZP.div`
  display: flex;
  justify-content: space-between;
  position: absolute;
  width: calc(100% - (var(--size-spacing-04) * 2));
